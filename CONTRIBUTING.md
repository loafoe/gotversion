# Contributing to Gotversion

We'd love for you to contribute to our source code and to make Gotversion even better than it is today!
...
* **Major Changes** open a ticket and lets discuss
...
In Github, send a pull request to original master branch: f.e. `gotversion:master`.
...
[github]: https://github.com/loafoe/gotversion/issues 
